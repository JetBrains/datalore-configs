...
export HUB_DATALORE_SERVICE_ID=changeme
export HUB_DATALORE_SERVICE_SECRET=changeme
...
export MAIL_SENDER_USERNAME=
export MAIL_SENDER_PASSWORD=
export MAIL_SMTP_SERVER=
